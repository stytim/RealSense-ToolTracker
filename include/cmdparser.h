...
namespace CmdParser
{
    ...
    {
    public:
        ArgumentError(const std::string option, const std::string message) : std::runtime_error(message),
                                                                             m_option(option),
                                                                             m_message(message)
        {
        }
    ...
    public:
        ...
        {
            RegisterOption(option_list, description, 0, [handler](const std::vector<char *> &)
                           { handler(); });
        }
